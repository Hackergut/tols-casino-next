...
const PLATFORM_STRINGS: Record<Locale, Dict> = {
  en: {
    "common.back":"Back","common.goTo":"Go to {target}","common.previous":"Previous","common.next":"Next","common.close":"Close","common.loading":"Loading…","common.viewAll":"View all","common.showMore":"Show more","common.showLess":"Show less","common.spin":"Spin","common.enter":"Enter","common.new":"New","common.hot":"Hot","common.live":"Live",
    "nav.home":"Home","nav.originals":"Originals","nav.slots":"Slots","nav.liveCasino":"Live Casino","nav.table":"Table Games","nav.recent":"Recent","nav.leaderboards":"Leaderboards","nav.settings":"Settings",
